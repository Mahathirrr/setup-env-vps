return {
	...
	config = function()
		...
		lspconfig["volar"].setup({
			capabilities = capabilities,
			on_attach = on_attach,
			filetypes = { "vue", "typescript", "javascript" }, -- Added explicit filetypes
			init_options = {
				vue = {
					hybridMode = false, -- Disable hybrid mode for better Vue support
				},
				typescript = {
		...
		-- IMPORTANT: Disable tsserver for Vue files to avoid conflicts
		lspconfig["tsserver"].setup({
			capabilities = capabilities,
			on_attach = on_attach,
			filetypes = { "javascript", "javascriptreact", "typescript", "typescriptreact" }, -- Removed vue from here
			settings = {
				javascript = {
					inlayHints = {
		...
		lspconfig["tailwindcss"].setup({
			capabilities = capabilities,
			on_attach = on_attach,
			filetypes = { "templ", "astro", "javascript", "typescript", "react", "vue" }, -- Added vue
			settings = {
				tailwindCSS = {
					includeLanguages = {
						templ = "html",
						vue = "html", -- Added Vue support
					},
